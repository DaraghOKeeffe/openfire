...
public class ContentFilterPlugin implements Plugin, PacketInterceptor {
    ...
    /**
     * Append a string to the current string of Patterns
     * 
     * @param contentFilterString
     * @author Wayne Mac Adams
     */
	public void appendContentFilter(String contentFilterString)
	{
		String current = this.getPatterns();
		String updated = current+','+contentFilterString;
		this.setPatterns(updated);
